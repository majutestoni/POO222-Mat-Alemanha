...
public Alemanha() {
		...
		// ADD PLAYERS
		Player p1 = new Player("Manuel Peter Neuer", LocalDate.parse("1986-03-27"), "Neuer", 1, 193, 93, "goalkeeper", "FC Bayern München");
		players.add(p1);
		Player p2 = new Player("Marc-André ter Stegen", LocalDate.parse("1992-04-30"), "Ter Stegen", 22, 187, 85, "goalkeeper", "FC Barcelona");
		players.add(p2);
		Player p3 = new Player("Kevin Trapp", LocalDate.parse("1990-07-08"), "Trapp", 12, 189, 88, "goalkeeper", "Eintracht Frankfurt");
		players.add(p3);
		Player p4 = new Player("Armel Bella-Kotchap", LocalDate.parse("2001-12-11"), "Bella-Kotchap", 25, 190, 87, "central back", "Southampton F.C.");
		players.add(p4);
		Player p5 = new Player("Matthias Lukas Ginter", LocalDate.parse("1994-01-19"), "Ginter", 4, 191, 86, "central back", "SC Freiburg");
		players.add(p5);
		Player p6 = new Player("Christian Günter", LocalDate.parse("1993-02-28"), "Günter", 20, 184, 83, "left back", "SC Freiburg");
		players.add(p6);
		Player p7 = new Player("Jan Thilo Kehrer", LocalDate.parse("1996-09-21"), "Kehrer", 5, 186, 76, "central back", "West Ham United FC");
		players.add(p7);
		Player p8 = new Player("Lukas Manuel Klostermann", LocalDate.parse("1996-06-03"), "Klostermann", 16, 189, 88, "central back", "RB Leipzig");
		players.add(p8);
		Player p9 = new Player("David Raum", LocalDate.parse("1998-05-22"), "Raum", 3, 180, 75, "left back", "RB Leipzig");
		players.add(p9);
		Player p10 = new Player("Antonio Rüdiger", LocalDate.parse("1993-03-03"), "Rüdiger", 2, 190, 85, "central back", "Real Madrid CF");
		players.add(p10);		
		Player p11 = new Player("Nico Schlotterbeck", LocalDate.parse("1999-12-01"), "N.Schlotterbeck", 23, 191, 86, "central back", "Borussia Dortmund");
		players.add(p11);		
		Player p12 = new Player("Niklas Süle", LocalDate.parse("1995-09-03"), "Süle", 15, 195, 99, "central back", "Borussia Dortmund");
		players.add(p12);		
		Player p13 = new Player("Karim-David Adeyemi", LocalDate.parse("2002-01-18"), "Adeyemi", 24, 180, 69, "right wing", "Borussia Dortmund");
		players.add(p13);		
		Player p14 = new Player("Julian Brandt", LocalDate.parse("1996-05-02"), "Brandt", 17, 185, 83, "central attacking midfielder", "Borussia Dortmund");
		players.add(p14);
		Player p15 = new Player("Niclas Füllkrug", LocalDate.parse("1993-02-09"), "Brandt", 9, 189, 83, "striker", "Werder Bremen");
		players.add(p15);
		Player p16 = new Player("Serge David Gnabry", LocalDate.parse("1995-07-14"), "Gnabry", 10, 176, 77, "right wing", "FC Bayern München");
		players.add(p16);
		Player p17 = new Player("İlkay Gündoğan", LocalDate.parse("1990-10-24"), "Gündoğan", 8, 180, 80, "central midfielder", "Manchester City FC");
		players.add(p17);
		Player p18 = new Player("Kai Lukas Havertz", LocalDate.parse("1999-06-11"), "Havertz", 7, 190, 83, "central attacking midfielder", "Chelsea FC");
		players.add(p18);
		Player p19 = new Player("Jonas Hofmann", LocalDate.parse("1992-07-14"), "Hofmann", 18, 176, 73, "right wing", "Borussia Mönchengladbach");
		players.add(p19);
		Player p20 = new Player("Joshua Walter Kimmich", LocalDate.parse("1995-02-08"), "Kimmich", 6, 177, 75, "central defensive midfielder", "FC Bayern München");
		players.add(p20);
		Player p21 = new Player("Youssoufa Moukoko", LocalDate.parse("2004-11-20"), "Moukoko", 26, 179, 72, "striker", "Borussia Dortmund");
		players.add(p21);
		Player p22 = new Player("Thomas Müller", LocalDate.parse("1989-09-13"), "Müller", 13, 185, 76, "center forward", "FC Bayern München");
		players.add(p22);
		Player p23 = new Player("Jamal Musiala", LocalDate.parse("2003-02-26"), "Musiala", 14, 184, 70, "central attacking midfielder", "FC Bayern München");
		players.add(p23);
		Player p24 = new Player("Leroy Aziz Sané", LocalDate.parse("1996-01-11"), "Sané", 19, 183, 70, "left wing", "FC Bayern München");
		players.add(p24);
